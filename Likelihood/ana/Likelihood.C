...
void Likelihood(int tof_option, int energy_option)
{
  gStyle->SetOptStat(0);
  TFile *fin1 = new TFile(Form("/home/had/kohki/work/ML/Likelihood/buf/pdf_tof%dene%d.root", tof_option, energy_option));
  TFile *fin2 = new TFile("/home/had/kohki/work/ML/Likelihood/buf/inputML.root");
  ...
  for (int ip = 0; ip < 3; ++ip)
  {
    ...
    h_Likeli_S[ip]->GetXaxis()->SetTitleOffset(0.7);
    ...
    gEff[ip]->GetXaxis()->SetTitleOffset(0.7);
    ...
    gEff_SB[ip]->GetYaxis()->SetTitleOffset(0.7);
    ...
    gEff_SB[ip]->GetXaxis()->SetTitleOffset(0.7);
  ...
  c1->SaveAs(Form("/home/had/kohki/work/ML/Likelihood/ana/fig/Likelihood_tof%dene%d.png", tof_option, energy_option));
}
